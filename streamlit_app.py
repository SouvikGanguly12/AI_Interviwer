...
def _render_results_page():
    """Display full results after interview is complete."""
...
def _render_upload_and_generate():
    ...
    with colB:
        seed = st.text_input("Name (Optional)", value="", help="Affects nothing; helps you identify the session.")
    ...
    if uploaded is not None:
        ...
        if not st.session_state.questions:
            with st.spinner("Extracting text + generating interview questions..."):
                ...
                # detect presence of projects and certificates in resume text
                ...
                # order: project-related, cert-related, then generated resume questions
                questions = project_questions + cert_questions + resume_questions
